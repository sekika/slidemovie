...
1.  **Structure & Script (Markdown)**: You define *what* to say and show using a simple text file.
2.  **Visual Design (PowerPoint)**: You use PowerPoint's AI "Designer" to make it look professional.
3.  **Production (slidemovie)**: The tool automatically generates voiceovers, converts slides to images, and stitches everything into a synchronized video.
